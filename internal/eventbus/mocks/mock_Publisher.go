...
func (_mock *MockPublisher) Publish(ctx context.Context, event v2.Event) error {
...
//   - ctx context.Context
//   - event v2.Event
func (_e *MockPublisher_Expecter) Publish(ctx interface{}, event interface{}) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, event)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, event v2.Event)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, event v2.Event) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
